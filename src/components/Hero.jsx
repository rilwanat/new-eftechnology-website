...
import hero4 from '../assets/images/hero/hero6.jpg';
...
const Hero = ({  }) => {
  ...
  const headerText = [
    'We Provide Information Technology & Security Apps',
    '',
    'Leaders In Tracking Systems & Security Devices',
    ' ',
];
  const subText = [
  ...
  return (
    <div className="relative w-full h-[740px] overflow-hidden">
      ...
      <div className="mt-40 absolute inset-0 flex flex-col justify-center  text-white px-8 md:px-4 lg:px-16 xl:px-24 2xl:px-80 ">
        <motion.p
