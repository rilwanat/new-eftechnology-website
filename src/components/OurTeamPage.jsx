        ...
        <div className="w-full rounded-lg">
          ...
          >
            ...
            <div className=" flex flex-col md:flex-row items-center justify-between mt-4 ">
              <div onClick={() => { navigate('/team-member/gideon-egbuchulam'); }} 
              className="flex flex-col w-full md:w-1/3 justify-center items-center rounded-md shadow-md m-2 p-4 bg-white min-h-[200px] cursor-pointer border-2 border-white hover:border-black">
                <img
                ...
                <span
                  ...
                  style={{ color: "#EBEA1C" }}
                >
                  {"Chairman/Chief Executive Officer".toUpperCase()}
                </span>
                <div
                  className="bg-theme mb-2"
                ...
                <div
                  className="px-8 text-center mb-4"
                  style={{ fontSize: "16px", color: "#777777" }}
                >
                  Mr. Gideon has developed innovative solutions to many critical infrastructure needs worldwide.
                </div>
              </div>

              <div onClick={() => { navigate('/team-member/john-nix'); }}
              className="flex flex-col w-full md:w-1/3 justify-center items-center rounded-md shadow-md m-2 p-4 bg-white min-h-[200px] cursor-pointer border-2 border-white hover:border-black">
                <img
                  className="block h-60 w-60 mb-2 mt-4 rounded-lg"
                  src={nix}
                ...
                <span
                  ...
                  style={{ color: "#EBEA1C" }}
                >
                  {"Chief Financial Officer (CFO)".toUpperCase()}
                </span>
                <div
                  className="bg-theme mb-2"
                  style={{ width: "60px", height: "2px" }}
                ...
                <div
                  ...
                  style={{ fontSize: "16px", color: "#777777" }}
                >
                  Mr. Nix is the Chief Financial Officer (CFO) of E.F. Network
                  Ltd and the Managing Director of NSCG.
                </div>
              </div>

              <div onClick={() => { navigate('/team-member/john-hardy'); }}
              className="flex flex-col w-full md:w-1/3 justify-center items-center rounded-md shadow-md m-2 p-4 bg-white min-h-[200px] cursor-pointer border-2 border-white hover:border-black">
                <img
                  className="block h-60 w-60 mb-2 mt-4 rounded-lg"
                  src={hardy}
                ...
                <span
                  ...
                  style={{ color: "#EBEA1C" }}
                >
                  {"Chief Operating Officer (COO)".toUpperCase()}
                </span>
                <div
                  className="bg-theme mb-2"
                  style={{ width: "60px", height: "2px" }}
                ...
                <div
                  ...
                  style={{ fontSize: "16px", color: "#777777" }}
                >
                  Business leader with unique blend of engineerin, sales,
                  operations and entrepreneurial experience.
                </div>
              </div>
            </div>
          ...
          <div className='bg-theme mb-2' style={{ width: '60px', height: '2px' }}></div>
            ...
            We use technology to improve the normal conventional systems. 
              ...
              <div onClick={() => { navigate('/team-member/varadarajan-narayanan'); }}
              className="flex flex-col w-full md:w-1/3 justify-center items-center rounded-md shadow-md m-2 p-4 bg-white min-h-[200px] cursor-pointer border-2 border-white hover:border-black">
                <img
                  className="block h-60 w-60 mb-2 mt-4 rounded-lg"
                  src={vara}
                ...
                <span
                  ...
                  style={{ color: "#EBEA1C" }}
                >
                  {"Chief Information Officer (CIO)".toUpperCase()}
                </span>
                <div
                  className="bg-theme mb-2"
                  style={{ width: "60px", height: "2px" }}
                ...
                <div
                  ...
                  style={{ fontSize: "16px", color: "#777777" }}
                >
                  Electrical Engineer with 20+ experience in Industrial
                  Electronics, instrumentation and control.
                </div>
              </div>

              <div onClick={() => { navigate('/team-member/tom-manliclic'); }}
              className="flex flex-col w-full md:w-1/3 justify-center items-center rounded-md shadow-md m-2 p-4 bg-white min-h-[200px] cursor-pointer border-2 border-white hover:border-black">
                <img
                  className="block h-60 w-60 mb-2 mt-4 rounded-lg"
                  src={tom}
                ...
                <span
                  ...
                  style={{ color: "#EBEA1C" }}
                >
                  {"Chief Technology Officer (CTO)".toUpperCase()}
                </span>
                <div
                  className="bg-theme mb-2"
                  style={{ width: "60px", height: "2px" }}
                ...
                <div
                  ...
                  style={{ fontSize: "16px", color: "#777777" }}
                >
                  Tom is a tech-savvy professional with a pioneering career
                  reflecting strong leadership.
                </div>
              </div>
