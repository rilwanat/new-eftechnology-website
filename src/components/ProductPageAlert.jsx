...
export default function ProductPageAlert({ 
  ...
  <div className='w-full sm:w-7/10 flex flex-col  justify-center mt-12 mb-2'>
    <p className=' mb-2' style={{ color: '', fontWeight: '600', fontSize: '24px' }}>Alert Services</p>
    <div className='bg-theme mb-2' style={{ width: '80px', height: '4px' }}></div>
    <div className=" pr-8" style={{ fontSize: '16px', color: '#777777'   }}>
    Stay one step ahead of emergencies with our cutting-edge Alert Services—designed to 
    protect lives and keep communities informed when it matters most. Whether for national, 
    state, or local governments, our advanced technology ensures rapid, reliable alerts 
    during crises. When every second counts, trust E.F Network to deliver life-saving 
    notifications that empower response and safeguard the public. Your safety is our priority.
    </div>
  </div>
